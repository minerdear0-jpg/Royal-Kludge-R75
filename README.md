...
**Пресеты (C-слой):** день белый 100% / сумерки янтарь 50% / ночь зелёный 15% / гейминг (blackout + зоны). Смена — вспышка целевым цветом, затем fade 3 с (в гейминг 0.5 с). Sleep: 10 / 5 / — / 10 мин (ночник не гаснет). Вход и выход из sleep — плавное затухание/разгорание ~2 с. Профиль в EEPROM.
...
USB suspend (крышка ноута / сон хоста): после **10 с** непрерывного suspend лента гаснет тем же ~2 с fade, что и idle; пробуждение хоста — разгорание. Короткий Linux autosuspend (~2 с) подсветку не трогает. Пин A5 драйвера LED не опускаем — из-за этого раньше ломались RGB и Game Mode. `RGB_DISABLE_WHEN_USB_SUSPENDED` специально не включён. Энкодер тоже сбрасывает idle.
