...
| Ночник | ПК выключен, на USB ещё питание: через 10 с зелёный ночник. Энкодер: яркость зелёного (EEPROM) и вежливый клик выкл/вкл. Linux autosuspend ~2 с не включает |
...
USB suspend (ПК спит / выключен, VBUS есть): через **10 с** — зелёный ночник с яркостью зелёного пресета; энкодер крутит её и пишет EEPROM, клик — плавное выкл/вкл. Пробуждение хоста возвращает текущий пресет. Короткий Linux autosuspend (~2 с) не трогает ленту. Пин A5 не опускаем. `RGB_DISABLE_WHEN_USB_SUSPENDED` специально не включён.
