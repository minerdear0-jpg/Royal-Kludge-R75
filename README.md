...
| Game Mode | **Fn + G** |
| RGB | Fn + стрелки / клавиши на Fn-слое, либо VIA |
| Bootloader | Options: трижды **Q** |
| Сброс EEPROM | Options: трижды **Z** |

**Game Mode:** блокировка Win/Super, SOCD last-win на WASD, NKRO, WASD красные. Повтор **Fn+G** возвращает обычный режим. SOCD в Valorant считается Snap Tap — бан.
