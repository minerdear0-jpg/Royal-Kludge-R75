...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_FN_LYR] = LAYOUT(
        ...
        _______,  _______,  _______,  _______,  _______,  GAME_MODE_TOG,  _______,  _______,  _______,  _______,  _______,  _______,             LIGHT_NIGHTLIGHT,  KC_END,
        _______,  LIGHT_PROFILE_CYC,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   MO(_CTL_LYR), RM_VALU,
    ...
    [_CTL_LYR] = LAYOUT(
        ...
        _______,  _______,  TD_KB_CLR,   _______,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  GAME_MODE_TOG, _______,  _______,
